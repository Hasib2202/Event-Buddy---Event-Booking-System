    ...
    <div className="min-h-screen bg-gray-100 font-sans antialiased text-gray-900">
      ...
      <header className="bg-white shadow-sm py-4 px-6 md:px-12 flex justify-between items-center z-20 relative">
        <div className="flex items-center">
          <span className="text-xl font-bold text-blue-600">Event buddy.</span>
        </div>
        <div className="flex space-x-4">
          <button className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition duration-200 text-sm md:text-base">Sign in</button>
          <button className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition duration-200 text-sm md:text-base">Sign up</button>
        </div>
      </header>
      ...
      <section className="relative overflow-hidden py-20 md:py-32 lg:py-40 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 min-h-[400px]">
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-0">
          ...
          <div className="absolute top-8 md:top-16 left-4 md:left-16 w-36 md:w-48 transform -rotate-12 opacity-90">
            <Image src="/images/ticket-left.png" alt="One Way Ticket" width={200} height={100} objectFit="contain" /> {/* REPLACE with your actual image */}
          </div>
          {/* Right Ticket */}
          <div className="absolute top-16 md:top-24 right-4 md:right-16 w-36 md:w-48 transform rotate-6 opacity-90">
            <Image src="/images/ticket-right.png" alt="One Way Ticket" width={200} height={100} objectFit="contain" /> {/* REPLACE with your actual image */}
          </div>
          ...
          <div className="absolute inset-0 bg-no-repeat bg-center opacity-30" style={{ backgroundImage: 'url(/images/hero-bg-sparkles.svg)', backgroundSize: 'cover' }}>
      ...
      <section className="py-16 md:py-20 px-4 md:px-8 lg:px-16 bg-gray-100">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-8 ml-4">Upcoming Events</h2>
            ...
            <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col">
              ...
              <div className="p-5 flex-grow">
                <div className="text-xs font-semibold text-blue-600 mb-2 flex items-baseline">
                  ...
                  <span className="text-2xl font-extrabold text-gray-800">{event.date.day}</span>
                </div>
                  ...
                  {event.tags.map((tag, tagIdx) => (
                    <span
                      ...
                      className={`text-xs px-3 py-1 rounded-full font-medium ${
                        tag === 'Tech' ? 'bg-blue-100 text-blue-600' :
                        tag === 'Conference' ? 'bg-purple-100 text-purple-600' :
                        tag === 'AI' ? 'bg-green-100 text-green-600' :
