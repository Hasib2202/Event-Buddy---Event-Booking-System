...
export default function UserDashboard() {
  ...
  const handleCancelRegistration = async (eventId: number) => {
    // This would need a cancel booking endpoint
    toast.error("Cancel registration feature not implemented yet");
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-sm text-gray-600 font-semibold" style={{ color: "#250a63" }}>Hello, {userName}</span>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        {/* Dashboard Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2" style={{ color: "#250a63" }}>Dashboard</h1>
          <p className="text-gray-600 font-semibold" style={{ color: "#250a63" }}>
        ...
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-6" style={{ color: "#250a63" }}>
            My Registered Events
          </h2>

          {loading ? (
            <div className="flex items-center justify-center py-12">
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-indigo-600" style={{ color: "#250a63" }}></div>
            </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <button
                        onClick={() =>
                          handleCancelRegistration(aggregated.eventId)
                        }
